...
public interface DFSZinterface extends Remote{
	...
	public void initialized(int clientID, String IP, int port, String IP1, String IP2, String IP3, int port1, int port2, int port3) throws NotBoundException, Exception ;
